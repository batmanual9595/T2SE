...
public class CarBehavior : MonoBehaviour
{
    ...
    public float blockadeDistance = 20f; // Distance to move ahead
    public float reBlockadeDistance = 30f; // Distance to re-blockade

    void Start()
    {
        gameObject.layer = LayerMask.NameToLayer("EnemyCar");
